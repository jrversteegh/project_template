...
def build_module(build_type, config="", march=""):
    ...
    with dir_context(build_dir):
        ...
        if os.system(
            f"CMAKE_POLICY_VERSION_MINIMUM=3.5 conan install -of conan --profile={script_dir}/conan/PROJECT.profile --build=missing -s build_type={build_type} {script_dir}/conanfile.txt"
        ):
